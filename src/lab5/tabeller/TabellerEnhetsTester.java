...
class TabellerEnhetsTester {
	...
	void testSummerA() {
		...
		assertEquals(11, Tabeller.summerA(tabell1));
		assertEquals(1, Tabeller.summerA(tabell2));
		assertEquals(0, Tabeller.summerA(tabell3));
	...
	void testSummerB() {
		...
		assertEquals(11, Tabeller.summerB(tabell1));
		assertEquals(1, Tabeller.summerB(tabell2));
		assertEquals(0, Tabeller.summerB(tabell3));
	...
	void testSummerC() {
		...
		assertEquals(11, Tabeller.summerC(tabell1));
		assertEquals(1, Tabeller.summerC(tabell2));
		assertEquals(0, Tabeller.summerC(tabell3));
